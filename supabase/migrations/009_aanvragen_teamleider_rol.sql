...
-- 3. Teamleider RLS policies (ALLEEN simpele policies, GEEN subqueries op profiles)
-- Teamleider profiel: wordt afgedekt door migratie 014 "eigen_profiel" policy
-- Team data voor teamleiders: via Edge Function, NIET via RLS

-- Teamleider eigen gesprekken: via migratie 014 "teamleider_eigen_conversations"
